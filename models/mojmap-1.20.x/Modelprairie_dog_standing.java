...
public class Modelprairie_dog_standing<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "prairie_dog_standing"), "main");
	private final ModelPart standing_head;
	private final ModelPart standing_body;
	private final ModelPart standing_arm_r;
	private final ModelPart standing_arm_l;
	private final ModelPart standing_leg_r;
	private final ModelPart standing_leg_l;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition standing_head = partdefinition.addOrReplaceChild("standing_head",
				CubeListBuilder.create().texOffs(0, 12)
						.addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(19, 12)
						.addBox(-1.0F, -2.0F, -3.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 13.0F, 0.0F));

		PartDefinition standing_body = partdefinition.addOrReplaceChild("standing_body", CubeListBuilder.create()
				.texOffs(12, 16).addBox(-0.5F, -1.0F, 2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 22.0F, 0.0F));

		PartDefinition standing_chest_r1 = standing_body.addOrReplaceChild("standing_chest_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -1.5F, -4.5F, 5.0F, 3.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -4.5F, 0.5F, -1.5708F, 0.0F, 0.0F));

		PartDefinition standing_arm_r = partdefinition.addOrReplaceChild("standing_arm_r", CubeListBuilder.create(),
				PartPose.offset(-1.5F, 15.0F, -1.0F));

		PartDefinition standing_r_arm_r1 = standing_arm_r
				.addOrReplaceChild("standing_r_arm_r1",
						CubeListBuilder.create().texOffs(0, 4).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition standing_arm_l = partdefinition.addOrReplaceChild("standing_arm_l", CubeListBuilder.create(),
				PartPose.offset(1.5F, 15.0F, -1.0F));

		PartDefinition standing_l_arm_r1 = standing_arm_l
				.addOrReplaceChild("standing_l_arm_r1",
