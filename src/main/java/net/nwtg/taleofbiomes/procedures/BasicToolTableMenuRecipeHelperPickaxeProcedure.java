...
public class BasicToolTableMenuRecipeHelperPickaxeProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipePage == 9) {
			if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeHelperUpdateTimer == 0) {
				headTag = TaleOfBiomesModVariables.MapVariables.get(world).modNamespace + ":" + "basic_tool_table/part_head_pickaxes";
