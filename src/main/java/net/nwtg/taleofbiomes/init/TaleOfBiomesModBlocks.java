...
public class TaleOfBiomesModBlocks {
	...
	public static final RegistryObject<Block> BASIC_STONE_TABLE = REGISTRY.register("basic_stone_table", () -> new BasicStoneTableBlock());
	...
	public static final RegistryObject<Block> MARBLE_PRESSURE_PLATE = REGISTRY.register("marble_pressure_plate", () -> new MarblePressurePlateBlock());
	public static final RegistryObject<Block> MARBLE_BUTTON = REGISTRY.register("marble_button", () -> new MarbleButtonBlock());
	public static final RegistryObject<Block> COBBLED_MARBLE = REGISTRY.register("cobbled_marble", () -> new CobbledMarbleBlock());
	public static final RegistryObject<Block> COBBLED_MARBLE_STAIRS = REGISTRY.register("cobbled_marble_stairs", () -> new CobbledMarbleStairsBlock());
	public static final RegistryObject<Block> COBBLED_MARBLE_SLAB = REGISTRY.register("cobbled_marble_slab", () -> new CobbledMarbleSlabBlock());
	public static final RegistryObject<Block> COBBLED_MARBLE_WALL = REGISTRY.register("cobbled_marble_wall", () -> new CobbledMarbleWallBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_MARBLE = REGISTRY.register("mossy_cobbled_marble", () -> new MossyCobbledMarbleBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_MARBLE_STAIRS = REGISTRY.register("mossy_cobbled_marble_stairs", () -> new MossyCobbledMarbleStairsBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_MARBLE_SLAB = REGISTRY.register("mossy_cobbled_marble_slab", () -> new MossyCobbledMarbleSlabBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_MARBLE_WALL = REGISTRY.register("mossy_cobbled_marble_wall", () -> new MossyCobbledMarbleWallBlock());
	...
	public static final RegistryObject<Block> BASALT_STAIRS = REGISTRY.register("basalt_stairs", () -> new BasaltStairsBlock());
	public static final RegistryObject<Block> BASALT_SLAB = REGISTRY.register("basalt_slab", () -> new BasaltSlabBlock());
	public static final RegistryObject<Block> BASALT_WALL = REGISTRY.register("basalt_wall", () -> new BasaltWallBlock());
	public static final RegistryObject<Block> BASALT_PRESSURE_PLATE = REGISTRY.register("basalt_pressure_plate", () -> new BasaltPressurePlateBlock());
	public static final RegistryObject<Block> BASALT_BUTTON = REGISTRY.register("basalt_button", () -> new BasaltButtonBlock());
	public static final RegistryObject<Block> COBBLED_BASALT = REGISTRY.register("cobbled_basalt", () -> new CobbledBasaltBlock());
	public static final RegistryObject<Block> COBBLED_BASALT_STAIRS = REGISTRY.register("cobbled_basalt_stairs", () -> new CobbledBasaltStairsBlock());
	public static final RegistryObject<Block> COBBLED_BASALT_SLAB = REGISTRY.register("cobbled_basalt_slab", () -> new CobbledBasaltSlabBlock());
	public static final RegistryObject<Block> COBBLED_BASALT_WALL = REGISTRY.register("cobbled_basalt_wall", () -> new CobbledBasaltWallBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_BASALT = REGISTRY.register("mossy_cobbled_basalt", () -> new MossyCobbledBasaltBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_BASALT_STAIRS = REGISTRY.register("mossy_cobbled_basalt_stairs", () -> new MossyCobbledBasaltStairsBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_BASALT_SLAB = REGISTRY.register("mossy_cobbled_basalt_slab", () -> new MossyCobbledBasaltSlabBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_BASALT_WALL = REGISTRY.register("mossy_cobbled_basalt_wall", () -> new MossyCobbledBasaltWallBlock());
	public static final RegistryObject<Block> POLISHED_BASALT = REGISTRY.register("polished_basalt", () -> new PolishedBasaltBlock());
	public static final RegistryObject<Block> POLISHED_BASALT_STAIRS = REGISTRY.register("polished_basalt_stairs", () -> new PolishedBasaltStairsBlock());
	...
	public static final RegistryObject<Block> POLISHED_BASALT_WALL = REGISTRY.register("polished_basalt_wall", () -> new PolishedBasaltWallBlock());
	public static final RegistryObject<Block> SHALE = REGISTRY.register("shale", () -> new ShaleBlock());
	public static final RegistryObject<Block> SHALE_FOSSIL = REGISTRY.register("shale_fossil", () -> new ShaleFossilBlock());
	...
	public static final RegistryObject<Block> SHALE_PRESSURE_PLATE = REGISTRY.register("shale_pressure_plate", () -> new ShalePressurePlateBlock());
	public static final RegistryObject<Block> SHALE_BUTTON = REGISTRY.register("shale_button", () -> new ShaleButtonBlock());
	public static final RegistryObject<Block> POLISHED_SHALE = REGISTRY.register("polished_shale", () -> new PolishedShaleBlock());
	public static final RegistryObject<Block> POLISHED_SHALE_STAIRS = REGISTRY.register("polished_shale_stairs", () -> new PolishedShaleStairsBlock());
	public static final RegistryObject<Block> POLISHED_SHALE_SLAB = REGISTRY.register("polished_shale_slab", () -> new PolishedShaleSlabBlock());
	public static final RegistryObject<Block> POLISHED_SHALE_WALL = REGISTRY.register("polished_shale_wall", () -> new PolishedShaleWallBlock());
	...
	public static final RegistryObject<Block> MOSSY_COBBLED_SHALE = REGISTRY.register("mossy_cobbled_shale", () -> new MossyCobbledShaleBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_SHALE_STAIRS = REGISTRY.register("mossy_cobbled_shale_stairs", () -> new MossyCobbledShaleStairsBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_SHALE_SLAB = REGISTRY.register("mossy_cobbled_shale_slab", () -> new MossyCobbledShaleSlabBlock());
	public static final RegistryObject<Block> MOSSY_COBBLED_SHALE_WALL = REGISTRY.register("mossy_cobbled_shale_wall", () -> new MossyCobbledShaleWallBlock());
	...
	public static final RegistryObject<Block> GHOST_BUSH_0 = REGISTRY.register("ghost_bush_0", () -> new GhostBush0Block());
	public static final RegistryObject<Block> GHOST_BUSH_1 = REGISTRY.register("ghost_bush_1", () -> new GhostBush1Block());
	public static final RegistryObject<Block> GHOST_BUSH_2 = REGISTRY.register("ghost_bush_2", () -> new GhostBush2Block());
	public static final RegistryObject<Block> GHOST_BUSH_3 = REGISTRY.register("ghost_bush_3", () -> new GhostBush3Block());
