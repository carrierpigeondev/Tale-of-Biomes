...
public class TaleOfBiomesModBlocks {
	...
	public static final DeferredHolder<Block, Block> PLOT_BLUEPRINT = REGISTRY.register("plot_blueprint", PlotBlueprintBlock::new);
	public static final DeferredHolder<Block, Block> WALL_BLUEPRINT = REGISTRY.register("wall_blueprint", WallBlueprintBlock::new);
	public static final DeferredHolder<Block, Block> DOOR_BLUEPRINT = REGISTRY.register("door_blueprint", DoorBlueprintBlock::new);
	public static final DeferredHolder<Block, Block> WINDOW_BLUEPRINT = REGISTRY.register("window_blueprint", WindowBlueprintBlock::new);
	...
	public static final DeferredHolder<Block, Block> SOLAR_PANNEL = REGISTRY.register("solar_pannel", SolarPannelBlock::new);
	public static final DeferredHolder<Block, Block> PIRUFF_SAPLING = REGISTRY.register("piruff_sapling", PiruffSaplingBlock::new);
	public static final DeferredHolder<Block, Block> COPPER_BATTERY_0 = REGISTRY.register("copper_battery_0", CopperBattery0Block::new);
	public static final DeferredHolder<Block, Block> COPPER_BATTERY_1 = REGISTRY.register("copper_battery_1", CopperBattery1Block::new);
	public static final DeferredHolder<Block, Block> COPPER_BATTERY_2 = REGISTRY.register("copper_battery_2", CopperBattery2Block::new);
	public static final DeferredHolder<Block, Block> COPPER_BATTERY_3 = REGISTRY.register("copper_battery_3", CopperBattery3Block::new);
	public static final DeferredHolder<Block, Block> COPPER_BATTERY_4 = REGISTRY.register("copper_battery_4", CopperBattery4Block::new);
	public static final DeferredHolder<Block, Block> DRILL = REGISTRY.register("drill", DrillBlock::new);
