...
public class TaleOfBiomesModItems {
	...
	public static final RegistryObject<Item> BASIC_STONE_TABLE = block(TaleOfBiomesModBlocks.BASIC_STONE_TABLE);
	...
	public static final RegistryObject<Item> MARBLE_STAIRS = block(TaleOfBiomesModBlocks.MARBLE_STAIRS);
	public static final RegistryObject<Item> MARBLE_SLAB = block(TaleOfBiomesModBlocks.MARBLE_SLAB);
	public static final RegistryObject<Item> MARBLE_WALL = block(TaleOfBiomesModBlocks.MARBLE_WALL);
	public static final RegistryObject<Item> MARBLE_PRESSURE_PLATE = block(TaleOfBiomesModBlocks.MARBLE_PRESSURE_PLATE);
	public static final RegistryObject<Item> MARBLE_BUTTON = block(TaleOfBiomesModBlocks.MARBLE_BUTTON);
	public static final RegistryObject<Item> COBBLED_MARBLE = block(TaleOfBiomesModBlocks.COBBLED_MARBLE);
	public static final RegistryObject<Item> COBBLED_MARBLE_STAIRS = block(TaleOfBiomesModBlocks.COBBLED_MARBLE_STAIRS);
	public static final RegistryObject<Item> COBBLED_MARBLE_SLAB = block(TaleOfBiomesModBlocks.COBBLED_MARBLE_SLAB);
	public static final RegistryObject<Item> COBBLED_MARBLE_WALL = block(TaleOfBiomesModBlocks.COBBLED_MARBLE_WALL);
	public static final RegistryObject<Item> MOSSY_COBBLED_MARBLE = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_MARBLE);
	public static final RegistryObject<Item> MOSSY_COBBLED_MARBLE_STAIRS = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_MARBLE_STAIRS);
	public static final RegistryObject<Item> MOSSY_COBBLED_MARBLE_SLAB = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_MARBLE_SLAB);
	public static final RegistryObject<Item> MOSSY_COBBLED_MARBLE_WALL = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_MARBLE_WALL);
	public static final RegistryObject<Item> POLISHED_MARBLE = block(TaleOfBiomesModBlocks.POLISHED_MARBLE);
	public static final RegistryObject<Item> POLISHED_MARBLE_STAIRS = block(TaleOfBiomesModBlocks.POLISHED_MARBLE_STAIRS);
	public static final RegistryObject<Item> POLISHED_MARBLE_SLAB = block(TaleOfBiomesModBlocks.POLISHED_MARBLE_SLAB);
	public static final RegistryObject<Item> POLISHED_MARBLE_WALL = block(TaleOfBiomesModBlocks.POLISHED_MARBLE_WALL);
	public static final RegistryObject<Item> BASALT = block(TaleOfBiomesModBlocks.BASALT);
	public static final RegistryObject<Item> BASALT_STAIRS = block(TaleOfBiomesModBlocks.BASALT_STAIRS);
	public static final RegistryObject<Item> BASALT_SLAB = block(TaleOfBiomesModBlocks.BASALT_SLAB);
	public static final RegistryObject<Item> BASALT_WALL = block(TaleOfBiomesModBlocks.BASALT_WALL);
	public static final RegistryObject<Item> BASALT_PRESSURE_PLATE = block(TaleOfBiomesModBlocks.BASALT_PRESSURE_PLATE);
	public static final RegistryObject<Item> BASALT_BUTTON = block(TaleOfBiomesModBlocks.BASALT_BUTTON);
	public static final RegistryObject<Item> COBBLED_BASALT = block(TaleOfBiomesModBlocks.COBBLED_BASALT);
	public static final RegistryObject<Item> COBBLED_BASALT_STAIRS = block(TaleOfBiomesModBlocks.COBBLED_BASALT_STAIRS);
	public static final RegistryObject<Item> COBBLED_BASALT_SLAB = block(TaleOfBiomesModBlocks.COBBLED_BASALT_SLAB);
	public static final RegistryObject<Item> COBBLED_BASALT_WALL = block(TaleOfBiomesModBlocks.COBBLED_BASALT_WALL);
	public static final RegistryObject<Item> MOSSY_COBBLED_BASALT = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_BASALT);
	public static final RegistryObject<Item> MOSSY_COBBLED_BASALT_STAIRS = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_BASALT_STAIRS);
	public static final RegistryObject<Item> MOSSY_COBBLED_BASALT_SLAB = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_BASALT_SLAB);
	public static final RegistryObject<Item> MOSSY_COBBLED_BASALT_WALL = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_BASALT_WALL);
	public static final RegistryObject<Item> POLISHED_BASALT = block(TaleOfBiomesModBlocks.POLISHED_BASALT);
	public static final RegistryObject<Item> POLISHED_BASALT_STAIRS = block(TaleOfBiomesModBlocks.POLISHED_BASALT_STAIRS);
	public static final RegistryObject<Item> POLISHED_BASALT_SLAB = block(TaleOfBiomesModBlocks.POLISHED_BASALT_SLAB);
	public static final RegistryObject<Item> POLISHED_BASALT_WALL = block(TaleOfBiomesModBlocks.POLISHED_BASALT_WALL);
	public static final RegistryObject<Item> SHALE = block(TaleOfBiomesModBlocks.SHALE);
	public static final RegistryObject<Item> SHALE_FOSSIL = block(TaleOfBiomesModBlocks.SHALE_FOSSIL);
	public static final RegistryObject<Item> SHALE_STAIRS = block(TaleOfBiomesModBlocks.SHALE_STAIRS);
	public static final RegistryObject<Item> SHALE_SLAB = block(TaleOfBiomesModBlocks.SHALE_SLAB);
	public static final RegistryObject<Item> SHALE_WALL = block(TaleOfBiomesModBlocks.SHALE_WALL);
	public static final RegistryObject<Item> SHALE_PRESSURE_PLATE = block(TaleOfBiomesModBlocks.SHALE_PRESSURE_PLATE);
	public static final RegistryObject<Item> SHALE_BUTTON = block(TaleOfBiomesModBlocks.SHALE_BUTTON);
	public static final RegistryObject<Item> POLISHED_SHALE = block(TaleOfBiomesModBlocks.POLISHED_SHALE);
	public static final RegistryObject<Item> POLISHED_SHALE_STAIRS = block(TaleOfBiomesModBlocks.POLISHED_SHALE_STAIRS);
	public static final RegistryObject<Item> POLISHED_SHALE_SLAB = block(TaleOfBiomesModBlocks.POLISHED_SHALE_SLAB);
	public static final RegistryObject<Item> POLISHED_SHALE_WALL = block(TaleOfBiomesModBlocks.POLISHED_SHALE_WALL);
	public static final RegistryObject<Item> COBBLED_SHALE = block(TaleOfBiomesModBlocks.COBBLED_SHALE);
	public static final RegistryObject<Item> COBBLED_SHALE_STAIRS = block(TaleOfBiomesModBlocks.COBBLED_SHALE_STAIRS);
	public static final RegistryObject<Item> COBBLED_SHALE_SLAB = block(TaleOfBiomesModBlocks.COBBLED_SHALE_SLAB);
	public static final RegistryObject<Item> COBBLED_SHALE_WALL = block(TaleOfBiomesModBlocks.COBBLED_SHALE_WALL);
	public static final RegistryObject<Item> MOSSY_COBBLED_SHALE = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_SHALE);
	public static final RegistryObject<Item> MOSSY_COBBLED_SHALE_STAIRS = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_SHALE_STAIRS);
	public static final RegistryObject<Item> MOSSY_COBBLED_SHALE_SLAB = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_SHALE_SLAB);
	public static final RegistryObject<Item> MOSSY_COBBLED_SHALE_WALL = block(TaleOfBiomesModBlocks.MOSSY_COBBLED_SHALE_WALL);
